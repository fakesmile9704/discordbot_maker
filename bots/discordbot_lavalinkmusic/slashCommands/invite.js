  ...
  options: [ 
    ...
    try {    
      if(user) {
        ...
        let button_public_invite = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.public)).setURL("https://discord.com/api/oauth2/authorize?client_id=986336804229767209&permissions=8&scope=bot%20applications.commands")
        let button_support_dc = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.server)).setURL("https://discord.gg/m7MgvmSMER")
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(client.getFooter(`${user.username} | powered by teamarcades.xyz`, "https://i.imgur.com/ebS0roV.png"))],
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${client.user.username} | powered by teamarcades.xyz`, "https://i.imgur.com/ebS0roV.png")],
          components: allbuttons
        });
      }
    } catch (e) {
